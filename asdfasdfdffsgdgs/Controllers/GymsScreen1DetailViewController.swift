//
//  GymsScreen1DetailViewController.swift
//  Asdfasdfdffsgdgs
//
...
class GymsScreen1DetailViewController: DataViewController<GymsScreen1DSItem> {
	...
	override init() {
        ...
        datasource = DatasourceManager.sharedInstance.GymsScreen1DS
	...
	func setupConstraints() {
		...
		contentConstraints.appendContentsOf(NSLayoutConstraint.constraintsWithVisualFormat("V:|-margin-[imageUrl1]-margin-[titleLabel2]-margin-[titleLabel3Header]-margin-[titleLabel3]-margin-[titleLabel4Header]-margin-[titleLabel4]-margin-[titleLabel5Header]-margin-[titleLabel5]-(>=margin)-|",
            options: .DirectionLeadingToTrailing,
            metrics: metrics,
            views: views))
...
extension GymsScreen1DetailViewController: DataResponse {
