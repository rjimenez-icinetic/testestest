...
class RestaurantsViewController: TableViewController<RestaurantsDSItem>, UITableViewDataSource, UITableViewDelegate {
    ...
    override init() {
		...
		behaviors.append(FilterBehavior<RestaurantsFilterViewController>(viewController: self))
    ...
    override func viewDidLoad() {
        ...
        AnalyticsManager.sharedInstance?.analytics?.logPage("Restaurants")
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        let destinationViewController = RestaurantsDetailViewController()
...
extension RestaurantsViewController: DataResponse {
