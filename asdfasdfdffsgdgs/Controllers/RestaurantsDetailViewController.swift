...
class RestaurantsDetailViewController: DataViewController<RestaurantsDSItem> {
	...
	override init() {
        ...
        datasource = DatasourceManager.sharedInstance.RestaurantsDS
...
extension RestaurantsDetailViewController: DataResponse {
