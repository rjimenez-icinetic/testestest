...
class ListViewController: TableViewController<Item1>, UITableViewDataSource, UITableViewDelegate {
    ...
    override init() {
		...
		behaviors.append(CreateBehavior<ListFormViewController, Item1>(viewController: self))
    ...
    override func viewDidLoad() {
        ...
        AnalyticsManager.sharedInstance?.analytics?.logPage("List")
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        let destinationViewController = ListDetailViewController()
...
extension ListViewController: DataResponse {
