//
//  GymsScreen1ViewController.swift
//  Asdfasdfdffsgdgs
//
...
class GymsScreen1ViewController: TableViewController<GymsScreen1DSItem>, UITableViewDataSource, UITableViewDelegate {
    ...
    override init() {
		...
		behaviors.append(FilterBehavior<GymsScreen1FilterViewController>(viewController: self))
    ...
    override func viewDidLoad() {
        ...
        AnalyticsManager.sharedInstance?.analytics?.logPage("Gyms")
        title = NSLocalizedString("Gyms", comment: "")
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        let destinationViewController = GymsScreen1DetailViewController()
...
extension GymsScreen1ViewController: DataResponse {
