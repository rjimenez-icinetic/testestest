//
//  MenuItem0DetailViewController.swift
//  Asdfasdfdffsgdgs
//
...
class MenuItem0DetailViewController: DataViewController<Screen0DSItem> {
...
extension MenuItem0DetailViewController: DataResponse {
