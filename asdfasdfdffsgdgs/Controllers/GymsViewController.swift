...
class GymsViewController: TableViewController<GymsScreen1DSItem>, UITableViewDataSource, UITableViewDelegate {
    ...
    override init() {
		...
		behaviors.append(FilterBehavior<GymsFilterViewController>(viewController: self))
    ...
    override func viewDidLoad() {
        ...
        AnalyticsManager.sharedInstance?.analytics?.logPage("Gyms 2")
        title = NSLocalizedString("Gyms 2", comment: "")
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        let destinationViewController = GymsDetailViewController()
...
extension GymsViewController: DataResponse {
